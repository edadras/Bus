...
@section('title', __('web.payment.sandbox_title'))

@section('body')
<div class="grid min-h-dvh place-items-center px-6">
    <div class="glass-strong card w-full max-w-sm text-center">
        <span class="badge badge-warning mx-auto">{{ __('web.payment.sandbox_badge') }}</span>

        <h1 class="mt-5 text-lg font-bold">{{ __('web.payment.sandbox_heading') }}</h1>
        <p class="mt-3 text-sm leading-7 text-ink-400">{{ __('web.payment.sandbox_body') }}</p>
